...
public class AssessmentResource {
    ...
    @ApiMethod(
            name = "assessment.getByEmployee",
            path = "assessment/employee",
            httpMethod =ApiMethod.HttpMethod.GET
    )
    public AssessmentDTO getAssessmentByEmployee(@Named("employeeId") final Long key) throws NotFoundException{
        final AssessmentDTO assessment = assessmentService.lookupEmployee(key);
